...
STATEMENTS: List[str] = [
    ...
    # Unique MSISDN
    # -------------------------------------------------
    f"DROP TABLE TBL_ATL_PRED_{PM}_UNIQUE PURGE",
    f"""
    CREATE TABLE TBL_ATL_PRED_{PM}_UNIQUE AS
    SELECT DISTINCT MSISDN
    FROM TBL_ATL_PRED_{PM}
    """,
    ...
    SELECT /*+ PARALLEL(8) */
           ...
           CASE
               ...
               ELSE 'CG'
           END AS GROUP_TYPE
    FROM TBL_ATL_PRED_{PM} A
    LEFT JOIN TBL_ATL_PRED_{PM}_UNIQUE SAMPLE(5) B
    ...
    SELECT MSISDN,
           CASE
               WHEN DENO = 98  THEN 148
               WHEN DENO = 148 THEN 118
               WHEN DENO = 118 THEN 198
               WHEN DENO = 198 THEN 308
               WHEN DENO = 308 THEN 179
               WHEN DENO = 179 THEN 499
               WHEN DENO = 499 THEN 219
               WHEN DENO = 219 THEN 249
               WHEN DENO = 249 THEN 599
               WHEN DENO = 599 THEN 698
               WHEN DENO = 698 THEN 798
               WHEN DENO = 798 THEN 898
               WHEN DENO = 898 THEN 1148

               WHEN DENO = 20  THEN 29
               WHEN DENO = 29  THEN 39
               WHEN DENO = 39  THEN 49
               WHEN DENO = 49  THEN 119
               WHEN DENO = 119 THEN 228
               WHEN DENO = 228 THEN 99
               WHEN DENO = 99  THEN 158
               WHEN DENO = 158 THEN 197
               WHEN DENO = 197 THEN 319
               ...
               WHEN DENO = 217 THEN 598
               WHEN DENO = 598 THEN 258
               WHEN DENO = 258 THEN 279
               WHEN DENO = 279 THEN 699
