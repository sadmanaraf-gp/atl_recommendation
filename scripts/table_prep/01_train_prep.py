...
class DateParams:    
# ...existing code...
    _ref_date = datetime.date.today() # Fixed for Jan Run
...
STATEMENTS: List[str] = [
    ...
    """,
    # 19
    "DROP TABLE SA_TBL_ATL_BASE_01 PURGE",
    # 20
    f"""
    CREATE TABLE SA_TBL_ATL_BASE_01  AS
    ...
    """,
    # 22
    "DROP TABLE SA_TBL_ATL_BASE_02 PURGE",
    # 23
    f"""
    CREATE TABLE SA_TBL_ATL_BASE_02  AS
    ...
    INNER JOIN (SELECT  DISTINCT MSISDN FROM SA_TBL_ATL_BASE_01) B
      ON A.MSISDN = B.MSISDN
    WHERE A.JOINING_DATE < '{DP.joining_date_cutoff}'
    ...
    """,
    # 24
    "DROP TABLE SA_TBL_ATL_BASE_03 PURGE",
    # 25
    f"""
    CREATE TABLE SA_TBL_ATL_BASE_03 AS
    ...
    INNER JOIN (SELECT  MSISDN FROM SA_TBL_ATL_BASE_01) B
      ON A.MSISDN = B.MSISDN
    WHERE A.JOINING_DATE < '{DP.joining_date_cutoff}'
    GROUP BY A.MSISDN, TOTAL_DSTR, VOL_KB, MO_MOU, RECHARGE_CNT, RECHARGE_MAX,
             VOICEREV_TOTAL, DATAREV_TOTAL, MIXED_BUNDLE_REV, VOICEREV_TRIG, DATAREV_TRIG
